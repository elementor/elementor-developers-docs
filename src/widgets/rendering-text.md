...
The most common [widget rendering](/widgets/widget-rendering) use case is to print the value of a simple text control. These controls are usually found in the content tab.
